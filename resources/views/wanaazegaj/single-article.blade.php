...
{{--                            <span class="font-italic">{{$plan->sign_name }} and  {{$plan->sign_name_wana}} </span></h4>--}}
{{--not done yet --}}

                        {{--                            <span class="font-italic">{{$plan->payment->approved_by }} {{$plan->check_by_super_hidet}} </span></h4>--}}
{{--                            <span class="font-italic">{{$plan->sign_name }} {{$plan->check_by_super_hidet}} </span></h4>--}}
                    </h3>
