...
{{--                                    @endif--}}
            ...
            <form action="{{route('wanaazegaj-approve-report',$ekidreport->id)}}"
                  method="post">
                @csrf
                <a href="{{route('w1-ekid-report-list',$ekidreport->id)}}" type="submit" class="btn btn-info btn-sm " style="width: 130px;">
                    ወደ ዋናው ገጽ
                </a>
