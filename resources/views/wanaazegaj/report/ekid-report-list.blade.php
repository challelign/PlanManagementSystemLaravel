                                        ...
                                        @if(($elist->check_by_hidet == 1 && $elist->check_by_super_hidet == 0 &&
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('wanaazegaj-report-approve-details',$elist->id)}}"
                                                       class="btn btn-sm btn-info" style="width: 110px;">ሙሊውን እይ </a>

                                                </td>

                                                @if($elist->check_by_finance == 0)
                                                    <td>
                                                        <form action="{{route('wanaazegaj-approve-report',$elist->id)}}"
                                                              method="post">
                                                            @csrf
                                                            <button
