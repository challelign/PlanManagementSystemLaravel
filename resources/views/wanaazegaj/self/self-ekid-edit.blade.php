...
@section('content')
    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0 text-dark">የራስህ እቅዶች <small>ዝርዝር {{Auth::user()->department->name}}
                        </small>
                    </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                            ...
                            <div class="col-12">
                                ...
                                <div class="card-body">
                                    <div class="card-header font-weight-bold">
                                        የመስክ : ውሎ አበልና ትራንስፖርት ማስተካክል
                                    </div>
                                    <div class="card-body">
                                        <form
                                            action="{{route('self-update-ekid-wana',$plan->id)}}"
                                            method="POST">
                                            @csrf
                                            {{--                                title--}}
                                        ...
                                        <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-md-1">
                                                    <textarea class="form-control" name="nodate" readonly id='nodate'
                                                              style="height: 35px">  {{$plan->startdate}}</textarea>
                                                </div>
                                            </div>
                                        ...
                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="form-group row">
                                                <label for="pre_payment"
                                                       class="col-md-2 col-form-label text-md-right">ቅድመ ክፍያ መውሰድ
                                                    ትፈልጋለህ </label>
                                                <div class="col-md-8">
                                                    {{--                                        <span> Diff:</span> <span id='diff'> - </span> <span> Days</span>--}}
                                                    <select
                                                        class="form-control @error('pre_payment') is-invalid @enderror"
                                                        required
                                                        name="pre_payment">
                                                        <option selected disabled>ይምረጡ</option>
