            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    ...
                    <h1 class="m-0 text-dark">የተሰረዙ እቅዶች <small>ዝርዝር {{Auth::user()->department->name }}
                            <span class="badge badge-danger">{{   $i + $is}}</span>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body table-responsive p-0">
                            ...
                            @else
                                ...
                                @include('layouts.ekid-menu-canceled')
                                <div class="table pt-4">
                                    <table class="table table-hover table-striped table-bordered" id="dataTableAdmin"
                                        ...
                                        @foreach($planlist as $plist)
                                            @if(($plist->cancel == 1 &&
                                            $plist->check_by_hidet == 1 && $plist->check_by_super_hidet == 0 &&
                                                ...
                                                <tr>
                                                    ...
                                                    <td>@if($plist->check_by_super_hidet == 0)
                                                        ...
                                                        @else
                                                            <strong
                                                                class="text-info">{{$plist->sign_name_wana}}</strong>
                                                        @endif
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <a href="{{route('wanaazegaj-single-details',$plist->id)}}"
                                                           class="btn btn-sm btn-info p-2 mx-3" style="width: 100px">ሙሉው
                                                            እቅድ
                                                            እይ </a>
