...
@section('content')
    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0 text-dark"> ደረሰኝ ቁረጥ  <small>የእቅዶች ዝርዝር</small></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                ...
                                <table class="table table-hover table-striped table-bordered"  id="dataTableAdmin"  style="width:100%">
                                    ...
                                    && $plist->check_by_finance == 1))
                                            <tr>
                                                ...
                                                <td>{{$plist->enddate}}</td>
                                                <td>{{$plist->title}}</td>
                                                <td>{{$plist->payment->voucher_no}}</td>
                                                ...
                                                @if($plist->check_by_finance == 0)
                                                    <td>
                                                        <a href="{{route('first-payment', $plist->id)}}"
                                                           class="btn btn-sm btn-warning">Payment
                                                        </a>
                                                    </td>
                                                @endif
                                                ...
                                                <td>
                                                    @if($plist->check_by_hidet == 1 && $plist->check_by_super_hidet == 1 && $plist->check_by_finance == 1 )
                                                        <a href="{{route('invoice-print', $plist->id)}}"
