                    ...
                    <h1 class="m-0 text-dark">
                        {{$department->name}}  : የእቅዶች
                         ...
                         <small>ዝርዝር <span
                                ...
                                @if($plist->check_by_hidet == 1 && $plist->department_id === $plist->department->id && $plist->check_by_super_hidet == 1 && $plist->check_by_finance == 0 )
                                @if ($i ++) @endif
                                @endif
                        ...
                        <div class="card-body table-responsive p-0">
                            ...
                            @else
                                <table class="table table-hover table-striped table-bordered" id="dataTableAdmin" style="width:100%">
                                    ...
                                    <tbody>
                                    @foreach($planlist as $plist)
                                        @if(($plist->check_by_hidet == 1 && $plist->check_by_super_hidet == 1 && $plist->check_by_finance == 0))
                                            <tr>
