                ...
                <div class="col-sm-12">
                    <h1 class="m-0 text-dark">ያረጋገጥሃቸው የመስክና የከተማ <small>እቅድ ክንውን : {{Auth::user()->department->name}}
                            ...
                            @foreach($ekidreport as $elist)
                                @if( Auth::user()->department->id == $elist->user->department->id && Auth::user()->name == $elist->sign_name_wana )
                                    @if($elist->check_by_hidet == 1 && $elist->check_by_super_hidet == 1)
                                        @if ($i ++) @endif
                                    @endif
                                        ...
                                        @if(($elist->check_by_hidet == 1 &&  $elist->check_by_super_hidet == 1 &&
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('wanaazegaj-single-ekid-detail',$elist->id)}}"
