...
@section('content')
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0 text-dark">ደረሰኝ ቁረጥ የመስክና የከተማ <small>እቅድ ክንውን :
                            @if ($i = 0)@endif
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">ደረሰኝ ቁረጥ ፡ </h3>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('finance-report-approve-details',$elist->id)}}"
                                                       class="btn btn-sm btn-info my-2 " style="width: 110px;">ሙሉውን
                                                        እይ</a>
                                                </td>

                                                <td>
                                                    @if($elist->check_by_hidet == 1 && $elist->check_by_super_hidet == 1 && $elist->check_by_finance == 1 && $elist->is_ekid_complated)
                                                        <a href="{{route('ekid-print', $elist->id)}}"
                                                           class="btn btn-primary btn-sm my-2" style="width: 110px;">
                                                            ደረሰኝ ቁረጥ
                                                        </a>
                                                    @endif
                                                </td>
