...
@section('content')
    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0 text-dark"> ቅድመ ክፍያ የተሰራላቸው <small>እቅዶች ዝርዝር</small></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">ቅድመ ክፍያ የተሰራላቸው</h3>
                        ...
                        <div class="card-body table-responsive p-0">
                            ...
                            @foreach($planlist as $plist)
                                @if($plist->check_by_hidet == 1 && $plist->check_by_super_hidet == 1
                                        && $plist->check_by_finance == 1 && $plist->is_plan_complated == 0 )
                                    @if ($i ++) @endif
                                @endif
                            @endforeach
                            @if($i == 0)
