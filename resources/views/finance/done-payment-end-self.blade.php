                    ...
                    <div class="card">
                        ...
                        <div class="card-body table-responsive p-0">
                            ...
                            @foreach($planlist as $plist)
                                @if($plist->check_by_hidet == 1 && auth()->user()->name == $plist->payment->approved_by
                            ...
                            @else
                                <table class="table table-hover table-striped table-bordered" id="dataTableAdmin"
                                    ...
                                    @foreach($donePayment as $plist)
                                        @if(($plist->check_by_hidet == 1 && auth()->user()->name == $plist->payment->approved_by && $plist->check_by_super_hidet == 1
                                    && $plist->check_by_finance == 1 ))
                                            <tr>
