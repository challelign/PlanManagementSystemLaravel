            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0 text-dark">
                        {{$department->name}}
                        <small> የመስክና የከተማ እቅድ ክንውን ዝርዝር መርጠህ Rest አድርግ :
                            @if ($i = 0)@endif
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">የመስክና የከተማ ክንውን መርጠህ Rest አድርግ</h3>
...
{{--                                                    @else--}}
{{--                                                        <strong--}}
{{--                                                            class="text-info">{{$elist->payment->approved_by}}</strong>--}}
{{--                                                    @endif--}}
{{--                                                </td>--}}
                                                <td>
                                                    <a href="{{route('list-details-report-reset',$elist->id)}}"
                                                ...
                                                <td>
                                                    <a href="{{route('reset-report-form', $elist->id)}}"
                                                       class="btn btn-sm btn-info my-2" style="width: 110px">እቅድ ሪሴት አርግ </a>
                                                </td>
