...
@section('content')
    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0 text-dark">ያልታየ የምክትል አዘጋጅ/ምክትል ዳይሬክተር እቅድ <small>ዝርዝር {{Auth::user()->department->name}}
                            {{--reporter--}}
                            @if ($r = 0)@endif
...
{{--                                        <th>የአስተባባሪ ፊርማ</th>--}}
                                        ...
                                        <tbody>
                                        @foreach($planlist as $plist)
                                            @if(($plist->check_by_hidet == 0 && $plist->user->role_id == 4 && $plist->cancel == 0 && $plist->check_by_super_hidet == 1 && $plist->check_by_smanager == 0
