        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-footer row">
                    <a href="{{route('smanager')}}" class="btn btn-info btn-sm">ወደ ዋናው ተመለስ</a>
                    @if($plan->check_by_smanager != 1 || $plan->check_by_wmanager  == 1)
                        @if($plan->cancel == 0)
                            @if($plan->check_by_finance == 0)
                                <form action="{{route('smanager-approve-plan',$plan->id)}}"
                                      method="post">
                                    @csrf
                                    <button
                                        class="btn btn-sm btn-danger my-0">ማጽደቅ
                                    </button>
                                </form>
