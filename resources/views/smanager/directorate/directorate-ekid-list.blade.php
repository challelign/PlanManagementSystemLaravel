            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    ...
                    <h1 class="m-0 text-dark">
                        {{$department->name}}  : የእቅዶች

                         <small>ዝርዝር <span

                                @if ($i = 0)@endif
                                @foreach($planlist as $plist)
                                @if($plist->check_by_hidet == 1 && $plist->department_id === $plist->department->id && $plist->check_by_super_hidet == 1 && $plist->check_by_smanager == 0 && $plist->check_by_finance == 0 )
                                @if ($i ++) @endif
                                @endif
                                @endforeach
                        ...
                        <div class="card-body table-responsive p-0">
                            ...
                            @else
                                <table class="table table-hover table-striped table-bordered" id="dataTableAdmin" style="width:100%">
                                    ...
                                    <tbody>
                                    @foreach($planlist as $plist)
                                        @if(($plist->check_by_hidet == 1 && $plist->check_by_super_hidet == 1 && $plist->check_by_smanager == 0 && $plist->check_by_finance == 0))
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('smanager-approve-details',$plist->id)}}"
                                                       class="btn btn-sm btn-danger" style="width: 100px">ሙሉውን እይ </a>
