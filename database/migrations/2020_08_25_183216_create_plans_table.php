...
class CreatePlansTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('plans', function (Blueprint $table) {
            ...
            $table->string('sign_name')->nullable(); // id of user
            $table->string('sign_name_image')->nullable(); // id of user

            $table->string('sign_name_wana')->nullable(); // id of user
            $table->string('sign_name_wana_image')->nullable(); // id of user
